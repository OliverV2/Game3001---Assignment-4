...
public:
	...
	static bool LOSCheck(DisplayObject* from, DisplayObject* to, DisplayObject* obstacle, DisplayObject* obstacle1, DisplayObject* obstacle2, DisplayObject* obstacle3);
